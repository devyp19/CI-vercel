...
import { BACKEND_URL, FRESHTEAM_ORGANISATION_NAME, FRESHTEAM_TOKEN, KEKA_ORGANISATION_NAME, SUPABSE_CREDS } from "../constant/index";
...
export const deleteGoogleDriveFileFolder = (payload) =>
  apis.delete(
    `https://cors-anywhere.herokuapp.com/https://www.googleapis.com/drive/v3/files/${payload?.path}`,
    {
      ...payload,
      headers: {
...
export const postPreviewDropboxFile = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/sharing/create_shared_link_with_settings",
    {
      ...payload,
      data: payload?.data,
      headers: {
        Authorization: DROPBOX_BEARER_TOKEN,
        "Content-Type": "application/json",
        ...payload?.headers,
      },
    }
...
export const getTemporaryLinkOfDropbox = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/files/get_temporary_link",
    {
      data: {
        path: payload?.path,
      },
...
export const uploadFileToDropbox = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://content.dropboxapi.com/2/files/upload",
    {
      ...payload,
      headers: {
        Authorization: DROPBOX_BEARER_TOKEN,
        "Content-Type": "application/octet-stream",
        "Dropbox-API-Arg": payload?.path,
        ...payload?.headers,
      },
      data: payload?.file,
    }
...
export const postOneDropboxFileFolders = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/files/list_folder",
    {
      ...payload,
      data: payload?.data,
      headers: {
...
export const getGoogleDriveFolders = (payload) =>
  apis.get(
    "https://cors-anywhere.herokuapp.com/https://www.googleapis.com/drive/v3/files?fields=*",
    {
      ...payload,
      headers: {
        Authorization: GOOGLE_BEARER_TOKEN,
...
export const postCreateDropboxFolder = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/files/create_folder_v2",
    {
      headers: {
        Authorization: DROPBOX_BEARER_TOKEN,
        "content-type": "application/json",
...
export const deleteDropboxFileFolder = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/files/delete_v2",
    {
      headers: {
        Authorization: DROPBOX_BEARER_TOKEN,
        "content-type": "application/json",
...
export const patchRenameDropboxFileFolder = (payload) =>
  apis.post(
    "https://cors-anywhere.herokuapp.com/https://api.dropboxapi.com/2/files/move_v2",
    {
      headers: {
        Authorization: DROPBOX_BEARER_TOKEN,
        "content-type": "application/json",

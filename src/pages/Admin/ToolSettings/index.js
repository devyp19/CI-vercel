...
import { BACKEND_URL, FILE_FOLDER_TOKEN_CONST, KEKA_CREDS, KEKA_ORGANISATION_NAME } from "../../../constant";
...
// import { one_drive_token } from "../../../constant/kekaSecrets";
...
const tempData = [
  {
    ...
    middle_name: "D",
    last_name: "Pancholi",
    display_name: "YASH_DHIWISE",
    gender: 1,
    birth_date: "2001-01-19T00:00:00Z",
    joining_date: "2021-12-06T00:00:00Z",
    phone_number: "8000464745",
    work_email: "yas.pancholi@dhiwise.com",
    job_title: "Software Development Executive - I",
    employee_number: "DW0073",
    // id: "47e00203-9cb3-48bf-b381-01998f62c56d",
    image: [
      {
        "33x33":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/33x33/profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
        "50x50":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/50x50profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
        "200x200":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/200x200/profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
      },
    ],
  },
  {
    ...
    middle_name: "D",
    last_name: "Pancholi",
    display_name: "YASH_personal",
    gender: 1,
    birth_date: "2001-01-19T00:00:00Z",
    joining_date: "2021-12-06T00:00:00Z",
    phone_number: "8000464745",
    work_email: "yashpancholi001@gmail.com",
    job_title: "Software Development Executive - II",
    employee_number: "DW0001",
    // id: "47e00203-9cb3-48bf-b381-01998f62c56DD",
    image: [
      {
        "33x33":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/33x33/profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
  ...
  },
  {
    ...
    phone_number: "8734943777",
    work_email: "bhaktii.chevli@dhiwise.com",
    job_title: "Software Development Executive - I",
    employee_number: "DW0074",
    // id: "55e672ea-2e9a-41aa-9f60-a31e104522b5",
    image: [
      {
        "33x33":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/33x33/profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
  ...
  },
  {
    ...
    gender: 1,
    birth_date: "2001-01-19T00:00:00Z",
    joining_date: "2022-03-16T00:00:00Z",
    phone_number: "1837461736",
    work_email: "prem.danejj@dhiwise.com",
    job_title: "Software Development Executive - I",
    employee_number: "DW0081",
    // id: "49a5293f-02ec-4d43-806e-a9f0a63aae11",
    image: [
      {
        "33x33":
          "https://dhiwise.keka.com/files/291bf6e5-c8dc-453b-bcc6-aea4be27790d/33x33/profileimage/c73e1fbd971a45a2877688078730d0e8.jpg",
...
const ToolSettingsPage = () => {
  ...
  const onedriveForm = useForm(
    {
      client_id: "a1d2416d-a122-4b94-8e7e-2c2ea7f148c2",
      redirect_uri: "http://localhost:3000/admin/toolsettings",
      client_secret: "AVX8Q~5nZ2VcBIs0yfX82Oa6vRld~G9czQE.8aE_",
    },
  ...
  const googleDriveForm = useForm(
    {
      ...
      redirect_uri: "http://localhost:3000/admin/toolsettings",
      client_secret: "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",
    },
  ...
  const dropboxForm = useForm(
    {
      client_id: "bxh48nv98clqx8j",
      redirect_uri: "http://localhost:3000/admin/toolsettings",
      client_secret: "hu7z4r0uek5e8tw",
    },
    {
      validate: true,
  ...
  function callpostDropboxAccessTokenApi() {
    ...
    //       refresh_token:"wuNKWQaAWOkAAAAAAAAAAdQ2MPDdbI6Bf36GGdgKBhG8S4sfdQLU_IYtniDKaBAM",
    //       client_id:"bxh48nv98clqx8j",
    //       client_secret:"hu7z4r0uek5e8tw"
    //   }),
    // };
  ...
  async function inviteEmployee(i = 0) {
    let email = tempData[i]?.work_email;
    const req = { data: { email: email } };
    setisLoaderPercentage(true);
    await postInvite(req)
      .then((res) => {
        updateEmployee(tempData[i]);
        setpercentage(((i + 1) / tempData?.length) * 100);
        i + 1 < tempData?.length

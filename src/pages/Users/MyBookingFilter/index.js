...
const MyBookingFilterPage = () => {
  const [inputvalue, setInputvalue] = React.useState("");

  return (
    <>
      <Stack className="bg-gray_100 font-inter h-[1502px] mx-[auto] relative w-[100%]">
        ...
        <Column className="absolute bg-white_A700 border border-gray_300 border-solid flex flex-col h-[max-content] inset-y-[0] items-center justify-start max-w-[1576px] my-[auto] md:p-[12px] sm:p-[15px] p-[24px] sm:pl-[15px] sm:pr-[15px] right-[2%] rounded-radius8 w-[100%]">
          ...
          <Column className="flex flex-col justify-start sm:mb-[3px] md:mb-[4px] mb-[8px] sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
            <Column className="flex flex-col justify-start pt-[1px] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mx-[0] sm:px-[0] w-[10%] sm:w-[100%]">
                <Img
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
              <Button
              ...
              >
                <Column className="flex flex-col justify-start w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[auto] sm:mx-[0] sm:px-[0] rounded-radius8 sm:w-[100%] w-[90%]">
                    ...
                    <Text
                      className="font-normal ml-[176px] sm:ml-[70px] md:ml-[90px] not-italic text-black_900 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      12/12/2022
                    ...
                    <Text
                      className="font-normal ml-[107px] sm:ml-[42px] md:ml-[55px] not-italic text-black_900 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      09:00 AM - 06:00 PM
                    ...
                    <Text
                      className="font-normal sm:ml-[39px] md:ml-[51px] ml-[99px] not-italic text-black_900 w-[auto]"
                      as="h4"
                      variant="h4"
                    >
                      100 Members
        ...
        <Column className="absolute bg-black_900_99 flex flex-col justify-end md:p-[155px] sm:p-[15px] p-[301px] w-[100%]">
          <Column className="bg-white_A700 flex flex-col items-center justify-start max-w-[288px] md:ml-[22px] ml-[43px] sm:mt-[234px] md:mt-[302px] mt-[586px] sm:mx-[0] md:p-[15px] sm:p-[15px] p-[30px] sm:pl-[15px] sm:pr-[15px] rounded-radius12 shadow-bs1 w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between sm:px-[0] w-[100%]">
              <Column className="flex flex-col items-center justify-start mb-[1px] sm:mt-[1px] md:mt-[2px] mt-[5px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[29%]">
                <Text
                  className="font-medium text-black_901 w-[auto]"
                  as="h4"
                  variant="h4"
            ...
            <Column className="flex flex-col justify-start sm:mt-[11px] md:mt-[15px] mt-[30px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between w-[100%]">
                <Text
                  className="flex-grow font-medium mb-[1px] sm:mt-[1px] md:mt-[2px] mt-[5px] text-black_900"
                  as="h4"
                  variant="h4"
                >
                  Timing Slots
              ...
              <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[20px] sm:mt-[7px] sm:mx-[0] sm:px-[0] rounded-radius25 sm:w-[100%] w-[65%]">
                <CheckBox
                  className="font-medium text-[16px] text-bluegray_402"
                  inputClassName="h-[24px] mr-[5px] w-[24px]"
                  name="01000130"
                  label="01:00 - 01:30"
                  variant="OutlineBluegray101_1"
                ></CheckBox>
                <CheckBox
                  className="font-medium md:mt-[10px] mt-[20px] sm:mt-[7px] text-[16px] text-bluegray_402"
                  inputClassName="h-[24px] mr-[5px] w-[24px]"
                  name="01300200"
                  label="01:30 - 02:00"
                  variant="OutlineBluegray101_1"
                ...
                ></CheckBox>
                <CheckBox
                  className="font-medium md:mt-[10px] mt-[20px] sm:mt-[7px] text-[16px] text-bluegray_402 w-[100%]"
                  inputClassName="h-[24px] mr-[5px] w-[24px]"
                  name="02300300"
                  label="02:30 - 03:00"
                  variant="OutlineBluegray101_1"
...
export default MyBookingFilterPage;

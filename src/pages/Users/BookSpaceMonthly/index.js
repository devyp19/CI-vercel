                    ...
                    <Column className="flex flex-col items-center justify-end ml-[124px] md:ml-[64px] md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:pt-[1px] md:pt-[2px] pt-[5px] sm:px-[0] sm:w-[100%] w-[78%]">
                      <Column className="flex flex-col justify-start w-[100%]">
                        ...
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[32%]">
                          ...
                          />
                          <Text
                            className="font-normal sm:ml-[3px] md:ml-[4px] ml-[8px] not-italic text-black_900 w-[auto]"
                            as="h4"
                            variant="h4"
                          >
                            Day
                          ...
                          <Button
                            className="cursor-pointer font-normal sm:h-[16px] md:h-[21px] h-[40px] ml-[12px] sm:ml-[4px] md:ml-[6px] not-italic text-[16px] text-black_900 text-center sm:w-[15px] md:w-[20px] w-[40px]"
                            shape="RoundedBorder8"
                          ...
                          <Text
                            className="flex font-normal items-center ml-[12px] sm:ml-[4px] md:ml-[6px] not-italic text-black_900 w-[auto]"
                            as="h4"
                            variant="h4"
                          >
                            of
                        ...
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[12px] sm:mt-[4px] md:mt-[6px] sm:px-[0] w-[100%]">
                          <Img
                            ...
                            alt="airplane One"
                          />
                          <Column className="bg-bluegray_50 flex flex-col items-center sm:mx-[0] sm:p-[3px] md:p-[4px] p-[8px] rounded-radius8 sm:w-[100%] w-[46%]">

...
import {
  getEmployeeselect,
  getMySpacebookingselectCount,
  getMySpaceInvitationselectCount,
  getSpacebookingselect,
  getSpacebookingselectCount,
  getSpaceideq1,
  getSpaceinvitationselect,
  getSpaceresourcespaceideq55,
  postBookingInvitees,
  postBookingNotification,
  postSpacebooking,
  sendXYZEmail
} from "service/api";
...
const spaces = [{
  "space_name": "Amphitheater",
  "description": "An amphitheatre (British English) or amphitheater; both is an open-air venue used for entertainment, performances, and sports. ",
  "location": "10 Floor, Besides Cafeteria",
  "capacity": "200",
  "image_url": "",
  "resource": "Chair,Table",
  "id": 1,
},
{
  "space_name": "Cafeteria",
  "description": "A place to chill, eat and chat",
  "location": "10 Floor, Besides amphitheatre",
  "capacity": "100",
  "image_url": "",
  "resource": "Chair,Table",
  "id": 2,
},
{
  ...
  "description": "This room contains chairs and tables",
  "location": "10 Floor, opposite entrance",
  "capacity": "20",
  "image_url": "",
  "id": 3,
  "resource": "Chair,Table",
...
const BookSpaceDailyPage = () => {
  ...
  const [ViewBookapiData, setViewBookapiData] = React.useState([{
    "booking_title": "Sprint Planning",
    "booking_to": "2022-12-27 07:00:00+00",
    "booking_from": '2022-12-27 06:30:00+00',
    "host": "Raj",
    "booking_type": "discussion",
    "created_at": "2022-12-27 07:00:00+00"
  }, {
    "booking_title": "Salary Discussion",
    "booking_to": "2022-12-27 07:00:00+00",
    "booking_from": '2022-12-27 06:30:00+00',
    "host": "Rahul",
    "booking_type": "Q/A",
    ...
    "booking_title": "Laptop setup",
    "booking_to": "2022-12-27 07:00:00+00",
    "booking_from": '2022-12-27 06:30:00+00',
    "host": "Keyur",
    "booking_type": "lessons",
    "created_at": "2022-12-27 07:00:00+00"
  }]
  );
  const [ViewBookMyapiData, setViewBookMyapiData] = React.useState([{
    "booking_title": "Sprint Planning",
    "booking_to": "2022-12-27 07:00:00+00",
    "booking_from": '2022-12-27 06:30:00+00',
    "host": "Raj",
  ...
  const [ViewInviteMyapiData, setViewInviteMyapiData] = React.useState([{
    "booking_title": "Sprint Planning",
    "booking_to": "2022-12-27 07:00:00+00",
    "booking_from": '2022-12-27 06:30:00+00',
    "host": "Raj",
  ...
  const [currTab, setCurrTab] = React.useState(2);
  ...
  React.useEffect(() => {
    const demospace = spaces.filter((x) => x?.id === location?.state?.id);
    setapiData1(demospace);
  }, []);
  ...
  // const handleViewMyInvitation = async (data) => {
  //   const req = filterData
  //     ? { headers: { Range: data }, filterURL: filterData.join("&") }
  //     : { headers: { Range: data } };
  ...
  //   req.params = {
  //     select:
  //       "*,host:space_booking(booking_forName),title:space_booking(booking_title),from:space_booking(booking_from),to:space_booking(booking_to)",
  //     space_id: `eq.${location?.state?.id}`,
  //     employee_id: "eq.685",
  //   };
  //   getSpaceinvitationselect(req)
  //     .then((res) => {
  //       setViewInviteMyapiData(res);
  //       setToggle({
  //         book: false,
  //         myBook: false,
  //         viewBook: false,
  ...
  // const getCountMyBooking = async (data) => {
  //   const req = data
  //     ? { params: {} }
  //     : filterData
  //       ? { filterURL: filterData.join("&") }
  ...
  //   // !data && setIsLoading(true);
  //   await getMySpacebookingselectCount(req)
  //     .then((res) => {
  //       setSpaceCount(res[0]?.count);
  //       // !data && setIsLoading(false);
  //     })
  ...
  // const getCountMyInvitation = async (data) => {
  //   const req = data
  //     ? { params: {} }
  //     : filterData
  //       ? { filterURL: filterData.join("&") }
  ...
  //   // !data && setIsLoading(true);
  //   await getMySpaceInvitationselectCount(req)
  //     .then((res) => {
  //       setSpaceCount(res[0]?.count);
  //       // !data && setIsLoading(false);
  //     })
  ...
  //   const req = {
  //     params: { select: "id,first_name,last_name,work_email" },
  //   };
  ...
  const pagiantion = (count, rows, page) => {
    ...
    if (currTab === 2) {
      ...
      handleViewMyBooking(data);
    } else if (currTab === 4) {
      handleViewMyInvitation(data);
    }
  };
  ...
  //   req.params = {
  //     select: "*,employee:booked_for(first_name,last_name)",
  //     space_id: `eq.${location?.state?.id}`,
  ...
  function hostDropdown(data) {
    const options = data?.map(
      ({ id, first_name, last_name, work_email }, index) => {
        return {
          value: id,
  ...
  return (
    <Base title="My Space" headerType={2}>
      <Column className="bg-white_A700solid flex flex-col items-center justify-start sm:mt-[12px] md:mt-[16px] my-[32px] sm:mx-[0] md:p-[12px] sm:p-[15px] p-[18px] rounded-radius8 sm:w-[100%] w-[97%]">
        <Column className="flex flex-col items-center justify-start mb-[15px] sm:mb-[5px] md:mb-[7px] sm:px-[0] w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start sm:mt-[19px] md:mt-[25px] mt-[49px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                  ...
                  return (
                    <React.Fragment key={`apiData1ResponseEle${index}`}>
                      <Row className="flex flex-row justify-center w-[96%]">
                        {/* <Stack className="backdrop-opacity-[0.1] bg-indigo_700 lg:h-[214px] xl:h-[268px] 2xl:h-[301px] 3xl:h-[362px] rounded-radius8 w-[100%]"> */}
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-end gap-3 sm:mt-[19px] md:mt-[25px] mt-[50px] sm:mx-[0] sm:px-[0] rounded-radius8 sm:w-[100%] w-[100%]">
                <Button
                  className="cursor-pointer font-medium text-[16px] text-center text-white_A700 w-[12%]"
                  //onClick={() => toggleFunction("bookToggle")}
                  onClick={() => {
                    setCurrTab(1);
                    setToggle({
                      book: true,
                ...
                <Button
                  ...
                  className="cursor-pointer font-medium md:ml-[12px]  sm:ml-[9px] text-[16px] text-center text-white_A700 w-[12%]"
                >
                  View Booking
                </Button>
                <Button
                ...
                <Column className="items-center justify-start w-[100%]">
                  <Column className="bg-gray-100 flex flex-col justify-start md:ml-[64px] sm:mt-[11px] md:mt-[14px] mt-[29px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[100%]  border border-gray_300 border-solid ">
                    <Row className="flex flex-row items-center justify-center lg:pl-[39px] xl:pl-[49px] 2xl:pl-[55px] 3xl:pl-[66px] w-[100%] p-[10px]">
                      <Column className="flex flex-col items-center w-[15%] ">
                  ...
                  >
                    {ViewBookapiData?.length ? (
                              ...
                              <Column className="flex flex-col  3xl:my-[10px] lg:my-[6px] xl:my-[8px] 2xl:my-[9px] w-[100%]">
                                <Row className="flex flex-row items-center justify-center w-[100%] p-[10px]  border-l border-r border-b border-gray_300 border-solid ">
                                  ...
                                  <Text
                                    ...
                                    variant="h6"
                                  >
                                    {dayjs(apiDataResponseEle?.["booking_from"]).format("DD/MM/YYYY h:mm a")}
                                    {"-"}
                                    {dayjs(
                                  ...
                                  <Text
                                    className="font-medium text-center text-black_901 w-[30%]"
                                    as="h6"
                                    variant="h6"
                                  >
                      ...
                      <Row className="flex flex-row items-center justify-center w-[auto] mt-[50px] bg-gray-100">
                        <Text
              ...
              <footer className="bg-white_A700 lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%] mt-[32px]">
                ...
                <Column className="items-center justify-start w-[100%]">
                  <Column className="bg-gray-100 flex flex-col justify-start md:ml-[64px] sm:mt-[11px] md:mt-[14px] mt-[29px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[100%]  border border-gray_300 border-solid ">
                    <Row className="flex flex-row items-center justify-center lg:pl-[39px] xl:pl-[49px] 2xl:pl-[55px] 3xl:pl-[66px] w-[100%] p-[10px]">
                      ...
                      <Column className="items-center lg:ml-[122px] xl:ml-[152px] 2xl:ml-[171px] 3xl:ml-[206px] py-[2px] flex flex-col w-[15%]">
                        <Row className="items-center justify-center mb-[1px] w-[100%] flex flex-row">
                          <Text
                            className="rowtitle text-indigo_600"
                            as="h5"
                            variant="h5"
                          >
                            Created At
                      ...
                      <Column className="items-center lg:ml-[120px] xl:ml-[150px] 2xl:ml-[169px] 3xl:ml-[203px] py-[2px] flex flex-col w-[30%]">
                        <Row className="items-center justify-center w-[100%] flex flex-row">
                          <Text
                            className="font-normal sm:ml-[3px] md:ml-[4px] not-italic text-indigo_600"
                            as="h5"
                            variant="h5"
                          >
                            Host
                      ...
                      <Column className="items-center xl:ml-[116px] 2xl:ml-[130px] 3xl:ml-[156px] lg:ml-[92px] py-[2px] flex flex-col w-[15%]">
                        <Row className="items-center justify-center  w-[100%] flex flex-row">
                          <Text
                            className="font-normal text-center text-indigo_600"
                            as="h5"
                            variant="h5"
                          >
                            Booking Type
                      ...
                      <Column className="items-center xl:ml-[103px] 2xl:ml-[116px] 3xl:ml-[139px] lg:ml-[82px] py-[2px] flex flex-col w-[15%]">
                        <Row className="items-center justify-center w-[100%] flex flex-row">
                          <Text
                            className="font-normal sm:ml-[3px] md:ml-[4px] ml-[8px] mt-[3px] not-italic text-indigo_600"
                            as="h5"
                            variant="h5"
                          >
                            Booked From
                      ...
                      <Column className="items-center lg:ml-[45px] xl:ml-[56px] 2xl:ml-[63px] 3xl:ml-[76px] p-[2px] flex flex-col w-[10%]">
                        <Text
                          className="rowtitle text-indigo_600"
                          as="h5"
                          variant="h5"
                  ...
                  <List
                    ...
                    orientation="vertical"
                  >
                    {ViewBookMyapiData?.length ? (
                      ViewBookMyapiData?.map((apiDataResponseEle, index) => {
                        return (
                          <React.Fragment key={`apiDataResponseEle${index}`}>
                            <Column className="flex flex-col  3xl:my-[10px] lg:my-[6px] xl:my-[8px] 2xl:my-[9px] w-[100%]">
                              <Row className="flex flex-row items-center justify-center w-[100%] p-[10px]  border-l border-r border-b border-gray_300 border-solid ">
                                ...
                                {/* // ) : (
                                //   <div className="flex flex-row items-center justify-center lg:ml-[54px] xl:ml-[68px] 2xl:ml-[76px] 3xl:ml-[91px] rounded-radius8 w-[10%]"></div>
                                // )} */}
                              </Row>
                            </Column>
                          </React.Fragment>
              ...
              <footer className="bg-white_A700 lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] w-[100%] mt-[32px]">
                ...
                <Column className="items-center justify-start w-[100%]">
                  ...
                  <List
                    ...
                    orientation="vertical"
                  >
                    {ViewInviteMyapiData?.length ? (
                      ViewInviteMyapiData?.map((apiDataResponseEle, index) => {
                        return (
                          <React.Fragment key={`apiDataResponseEle${index}`}>
                            <Column className="flex flex-col  3xl:my-[10px] lg:my-[6px] xl:my-[8px] 2xl:my-[9px] w-[100%]">
                              <Row className="flex flex-row items-center justify-evenly w-[100%] p-[10px]  border-l border-r border-b border-gray_300 border-solid ">
                                ...
                                >
                                  {dayjs(
                                    apiDataResponseEle?.from?.["booking_from"]
                                  ).format("DD/MM/YYYY h:mm a")}
                                  {"-"}
                                  {dayjs(
                                    apiDataResponseEle?.to?.["booking_to"]
                                  ).format("DD/MM/YYYY h:mm a")}
                                </Text>
                                {apiDataResponseEle?.booking_from >=
                                  dayjs().format("YYYY-MM-DDT00:00:00.000Z")}

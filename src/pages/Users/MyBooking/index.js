    ...
    <>
      <Column className="bg-gray_100 flex flex-col font-inter items-center justify-start mx-[auto] sm:pb-[15px] md:pb-[29px] pb-[58px] w-[100%]">
        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly w-[100%]">
          <Column className="bg-white_A700 border border-gray_300 border-solid flex flex-col items-center justify-start max-w-[280px] sm:mb-[145px] md:mb-[187px] mb-[364px] ml-[auto] mr-[auto] sm:mx-[0] md:p-[12px] sm:p-[15px] p-[24px] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start max-w-[1640px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Column className="bg-white_A700 border border-gray_300 border-solid flex flex-col justify-end sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:p-[15px] md:p-[16px] p-[32px] rounded-radius8 sm:w-[100%] w-[97%]">
              <Column className="flex flex-col items-center justify-start mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[7%]">
                <Text
              ...
              <Column className="flex flex-col justify-start ml-[18px] md:ml-[9px] sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
              ...
              <Column className="flex flex-col justify-start sm:mt-[12px] md:mt-[16px] mt-[32px] sm:px-[0] w-[100%]">

...
import { BACKEND_URL, TECH_TAG } from "../../constant";
import {
  FRESHTEAM_TOKN,
  FRESHTEAM_URL,
...
const UserHeader = ({ className, children, prefix, suffix, ...restProps }) => {
  ...
  //   const data = {
  //     reciever: val?.email,
  //     subject: `Invitation to interview with DhiWise for the ${val?.job_title} position`,
  //     content: `Dear ${val?.name},\n\nThank you once again for applying to DhiWise for ${val?.job_title} position.\n\nAfter reviewing your application, we have decided to select you for the next round. I am thrilled to invite you for the first round of interviews. This interview round aims to get to know you better regarding the accomplishments you have made so far in your professional journey. We are interested in knowing the impact that your work has created.\n\nHave a look at the job description. Then you will have to do a simple activity in which you will have to compare your work with JD and need to provide us with a minimum of 5 examples (10 can be a perfect number) in a specific way like "Accomplished X, as measured by Y, by doing Z."\n\nBelow mentioned is the hint (example) of Accomplished X, as measured by Y, by doing Z\n1. If your Resume states, "Decreased server query response time." you should rephrase it as, "Decreased server query response time by 15 percent by restructuring our API. This is much more concrete and demonstrates how you made a positive change.\n\nX= Decreased server query response time Y= Rate of 15% Z= By restructuring API\n\nYou have 48 hours to submit this task. Once you finish task, click on link to upload the task in a PDF file.\n\nLooking forward to hearing back from you soon. All the best.\n\n\nKind regards,\nHR. Drashti Desai\nDhiWise Private Limited`,
  //   };
